...
DEFAULT_HOVER_COLOR_MULTS = (1.5, 1.5, 1.4)
...
DEFAULT_SENSOR_COLOR = (20,60,150)
...
DEFAULT_SENSOR_INACTIVE_COLOR = (70,70,60)
...
DEFAULT_LED_COLORS = [(0,20,25),(255,240,100)]
DEFAULT_LED_SIZE_PX = (GRID_SIZE_PX_X, BRICKS_OUTLINE_WIDTH_PX)
LED_TIMEOUT_FRAMES = 8
